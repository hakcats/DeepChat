...
from chat_core.core.common.log_events import get_tb_writer
...
from chat_core.core.trainers.fit_trainer import FitTrainer
from chat_core.core.trainers.utils import parse_metrics, NumpyArrayEncoder
...
class NNTrainer(FitTrainer):
    """
    | Bases :class:`~chat_core.core.trainers.FitTrainer`
    | Trainer class for training and evaluating pipelines containing
      :class:`Estimators <chat_core.core.models.estimator.Estimator>`
      and an :class:`~chat_core.core.models.nn_model.NNModel`
