...
from chat_core.core.commands.infer import build_model
from chat_core.core.common.chainer import Chainer
from chat_core.core.common.params import from_params
from chat_core.core.common.registry import register
from chat_core.core.data.data_fitting_iterator import DataFittingIterator
from chat_core.core.data.data_learning_iterator import DataLearningIterator
from chat_core.core.models.estimator import Estimator
from chat_core.core.trainers.utils import Metric, parse_metrics, prettify_metrics, NumpyArrayEncoder
...
class FitTrainer:
    """
    Trainer class for fitting and evaluating :class:`Estimators <chat_core.core.models.estimator.Estimator>`
    ...
    def fit_chainer(self, iterator: Union[DataFittingIterator, DataLearningIterator]) -> None:
        """
        Build the pipeline :class:`~chat_core.core.common.chainer.Chainer` and successively fit
        :class:`Estimator <chat_core.core.models.estimator.Estimator>` components using a provided data iterator
        """
        if self._built:
    ...
    def get_chainer(self) -> Chainer:
        """Returns a :class:`~chat_core.core.common.chainer.Chainer` built from ``self.chainer_config`` for inference"""
        self._load()
    ...
    def test(self, data: Iterable[Tuple[Collection[Any], Collection[Any]]],
        ...
        :class:`~chat_core.core.common.chainer.Chainer`
    ...
    def evaluate(self, iterator: DataLearningIterator,
        ...
        Args:
            iterator: :class:`~chat_core.core.data.data_learning_iterator.DataLearningIterator` used for evaluation
