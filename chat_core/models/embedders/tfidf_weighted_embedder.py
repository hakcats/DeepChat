...
from chat_core.core.data.utils import zero_pad
...
class TfidfWeightedEmbedder(Component):
    ...
    Examples:
        >>> from chat_core.models.embedders.tfidf_weighted_embedder import TfidfWeightedEmbedder
        >>> from chat_core.models.embedders.fasttext_embedder import FasttextEmbedder
