...
from chat_core.models.entity_extraction.entity_detection_parser import EntityDetectionParser
...
class NerChunkModel(Component):
    ...
    def __init__(self, ner: Chainer,
        ...
        Args:
            ...
            ner_parser: component chat_core.models.entity_extraction.entity_detection_parser
            ...
            ner_parser2: component chat_core.models.entity_extraction.entity_detection_parser
            **kwargs:
        """
        self.ner = ner
