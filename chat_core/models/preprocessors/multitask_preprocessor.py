...
from chat_core.models.preprocessors.torch_transformers_preprocessor import *
...
class MultiTaskPipelinePreprocessor(Component):
    ...
    preprocessor(str): name of DeepChat class that is used for tokenization.
    Default: TorchTransformersPreprocessor
    preprocessors(List[str]): list of names of DeepChat classes that are used for tokenization.
