...
from chat_core.models.kbqa.query_generator_base import QueryGeneratorBase
from chat_core.models.kbqa.rel_ranking_infer import RelRankerInfer
from chat_core.models.kbqa.utils import extract_year, extract_number, make_combs, fill_query, find_query_features, \
    make_sparql_query, merge_sparql_query
from chat_core.models.kbqa.wiki_parser import WikiParser
