...
from chat_core.core.common.file import load_pickle, read_json
...
from chat_core.models.kbqa.sentence_answer import sentence_answer
...
class RelRankerInfer(Component, Serializable):
    ...
    def __init__(self, load_path: str,
        ...
        Args:
            ...
            ranker: component chat_core.models.ranking.rel_ranker
            wiki_parser: component chat_core.models.wiki_parser
