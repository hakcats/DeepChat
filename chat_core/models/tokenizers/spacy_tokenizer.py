...
from chat_core.models.tokenizers.utils import detokenize, ngramize

logger = getLogger(__name__)


# TODO: make proper handling through spacy.cli.download in the stage of python -m chat_core download
...
class StreamSpacyTokenizer(Component):
    ...
    Args:
        ...
        alphas_only: whether to filter out non-alpha tokens; is performed by default by
         :meth:`_filter` method
        spacy_model: a string name of spacy model to use; DeepChat searches for this name in
         downloaded spacy models; default model is **en_core_web_sm**, it downloads automatically
         during DeepChat installation
