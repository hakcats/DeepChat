...
from chat_core.core.common.paths import get_settings_path, populate_settings_dir
...
def main():
    """DeepChat console configuration utility."""
    ...
    if args.default:
        ...
        print(f'Current DeepChat settings path: {path}')
