...
class TyposDatasetIterator(DataLearningIterator):
    """Implementation of :class:`~chat_core.core.data.data_learning_iterator.DataLearningIterator` used for training
     :class:`~chat_core.models.spelling_correction.brillmoore.ErrorModel`
