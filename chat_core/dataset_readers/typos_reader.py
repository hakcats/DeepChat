...
from chat_core.core.data.utils import is_done, download, mark_done
...
class TyposCustom(DatasetReader):
    ...
    def read(cls, data_path: str, *args, **kwargs) -> Dict[str, List[Tuple[str, str]]]:
        ...
        Args:
            data_path: path that needs to be interpreted with :meth:`~chat_core.dataset_readers.typos_reader.TyposCustom.build`

        Returns:
            train data to pass to a :class:`~chat_core.dataset_iterators.typos_iterator.TyposDatasetIterator`
        """
...
class TyposWikipedia(TyposCustom):
    """Implementation of :class:`~chat_core.dataset_readers.typos_reader.TyposCustom` that works with
...
class TyposKartaslov(DatasetReader):
    ...
    def read(data_path: str, *args, **kwargs) -> Dict[str, List[Tuple[str, str]]]:
        ...
        Args:
            data_path: path that needs to be interpreted with :meth:`~chat_core.dataset_readers.typos_reader.TyposKartaslov.build`
