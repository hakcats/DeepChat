    ...
    def read(self,
        ...
        if 'train.txt' not in {file_path.name for file_path in files}:
            if dataset_name == 'conll2003':
                url = 'http://files.deepchat.ai/deepchat_data/conll2003_v2.tar.gz'
            elif dataset_name == 'collection_rus':
                url = 'http://files.deepchat.ai/deepchat_data/collection3_v2.tar.gz'
            elif dataset_name == 'ontonotes':
                url = 'http://files.deepchat.ai/deepchat_data/ontonotes_ner.tar.gz'
            elif dataset_name == 'vlsp2016':
                url = 'http://files.deepchat.ai/deepchat_data/vlsp2016.tar.gz'
            elif dataset_name == 'dailydialog':
                url = 'http://files.deepchat.ai/deepchat_data/dailydialog.tar.gz'
            elif dataset_name == 'collection3':
                url = 'http://files.deepchat.ai/deepchat_data/collection3_anh.tar.gz'
            else:
