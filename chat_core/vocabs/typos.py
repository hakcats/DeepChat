...
from chat_core.core.common.file import load_pickle, save_pickle
from chat_core.core.common.registry import register
from chat_core.core.data.utils import is_done, mark_done
...
class RussianWordsVocab(StaticDictionary):
    """Implementation of :class:`~chat_core.vocabs.typos.StaticDictionary` that builds data from https://github.com/danakt/russian-words/
...
class Wiki100KDictionary(StaticDictionary):
    """Implementation of :class:`~chat_core.vocabs.typos.StaticDictionary` that builds data
