...
from chat_core.core.commands.infer import interact_model, predict_on_stream
from chat_core.core.commands.train import train_evaluate_model_from_config
from chat_core.core.common.cross_validation import calc_cv_score
from chat_core.core.common.file import find_config
from chat_core.download import deep_download
from chat_core.utils.pip_wrapper import install_from_config
from chat_core.utils.server import start_model_server
from chat_core.utils.socket import start_socket_server
...
parser.add_argument("--socket-file", default="/tmp/deepchat_socket.s", type=str)
