...
from chat_core.core.commands.utils import parse_config
from chat_core.core.common.chainer import Chainer
from chat_core.core.common.file import read_json
from chat_core.core.common.log import log_config
from chat_core.core.common.paths import get_settings_path
from chat_core.core.data.utils import check_nested_dict_keys, jsonify_data
from chat_core.utils.connector import DialogLogger
from chat_core.utils.server.metrics import metrics, PrometheusMiddleware
...
if COMPATIBILITY_MODE is not False:
    log.warning('DeepChat riseapi mode will use the old model response data format used up and including 1.0.0rc1.\n'
                'COMPATIBILITY_MODE will be removed in the DeepChat 1.2.0.\n'
